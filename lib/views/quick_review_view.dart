...
class _QuickReviewViewState extends State<QuickReviewView> {
  ...
  Future<void> _deleteSelected(
      BuildContext context, InventoryViewModel inventory, AppStrings s) async {
    ...
    if (confirmed == true) {
      ...
      if (context.mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text(s.garmentsDeleted)),
        );
      }
      _exitSelectionMode();
    }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
          ...
          ? AppBar(
              ...
              actions: [
                IconButton(
                  ...
                  onPressed: () =>
                      _deleteSelected(context, inventory, s),
                ),
              ],
            )
          : AppBar(
              ...
              itemBuilder: (context, index) {
                ...
                return Dismissible(
                  ...
                  child: GestureDetector(
                    ...
                    onDoubleTap: () {
                      inventory.setPendingState(
                          garment.id, GarmentState.inUse);
                      ScaffoldMessenger.of(context)
                          .clearSnackBars();
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          content: Text(
                              '${garment.name}: ${s.setInUse}'),
                          duration:
      ...
      floatingActionButton:
          !_selectionMode && inventory.hasPendingChanges
  ...
  void _showEditSheet(
    ...
    final categoryCtrl =
        TextEditingController(text: garment.category);
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SegmentedButton<GarmentState>(
                      ...
                      onSelectionChanged: (sel) => setModalState(
                          () => selectedState = sel.first),
                    ),
                    const SizedBox(height: 16),
                    SwitchListTile(
