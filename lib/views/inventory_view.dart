...
void showAddGarmentSheet(BuildContext context, InventoryViewModel inventory) {
  ...
  String selectedCategory = AppStrings.garmentCategories.first;
            ...
            child: Column(
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: AppStrings.garmentCategories.map((cat) {
                ...
                SwitchListTile(
                  ...
                  value: isCountBased,
                  onChanged: (val) => setModalState(() => isCountBased = val),
                ),
                if (isCountBased)
                  Row(
...
class _InventoryViewState extends State<InventoryView> {
  ...
  Widget build(BuildContext context) {
    ...
    final filteredGarments = inventory.garments.where((g) {
      final matchesCategory =
          _filterCategory == s.all ||
          _filterCategory == 'All' ||
          g.category == _filterCategory;
      ...
      final matchesSearch =
          ...
          s.translateCategory(g.category).toLowerCase().contains(query);
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final isSelected =
                    cat == _filterCategory ||
                    (index == 0 &&
                        (_filterCategory == 'All' || _filterCategory == s.all));
                return Padding(
            ...
            Row(
              children: [
                ...
                IconButton(
                  ...
                  onPressed: () =>
                      _confirmDelete(context, inventory, garment, s),
                  tooltip: s.delete,
                ),
              ],
            ),
    ...
    if (confirmed == true) {
      ...
      if (context.mounted) {
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(SnackBar(content: Text(s.garmentDeleted)));
      }
    }
  }
}
