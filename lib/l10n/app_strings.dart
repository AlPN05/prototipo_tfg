...
class AppStrings {
  ...
  String get selectAll => _s('Select All', 'Seleccionar todo');
  String get deselectAll => _s('Deselect All', 'Deseleccionar todo');
  String get search => _s('Search', 'Buscar');
  String get searchItems => _s('Search items...', 'Buscar prendas...');
  ...
  String get outfitNameHint => _s('e.g. Monday casual', 'ej: Lunes casual');
  ...
  /// Lista de todas las categorías de prendas disponibles.
